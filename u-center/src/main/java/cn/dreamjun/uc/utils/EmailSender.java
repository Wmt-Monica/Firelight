...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_163(false), "wmt3040988158@163.com",
                "HKJVLRHWUBWLXNMB");
    }
    ...
    /**
     * cn.dreamjun.base.config username and password
     *
     * @param props    email property cn.dreamjun.base.config
     ...
     * @param content     内容
     */
    public static void sendMailCode(String mailAddress, String content) {
        try {
            EmailSender.subject("萤火之光")
                    .from("邮箱验证码")
                    .text(content)
                    .to(mailAddress)
                    .send();
